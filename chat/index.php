...
<body>
  <h1 class="justify-content-left d-inline">SecureLink</h1>
    ...
    <div class="modal-dialog modal-dialog-scrollable">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <label class="btn btn-outline-dark" for="upload-file" style="cursor: pointer; display: none"><i style="font-size:16px;" class='fas fa-file-export'></i></label>
            <input type="file" id="upload-file" name="upload-file" style="opacity: 0; position: absolute; z-index: -1; display: none">
